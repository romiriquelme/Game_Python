...
class Game:
    ...
    def start_text(self):
        ...
        text = font.render('SPACE INVADER', True, 'yellow')
        text_rect = text.get_rect(center=(s_width/2, s_height/2))
        screen.blit(text, text_rect)

        font2 = pygame.font.SysFont('Calibri', 25)
        text2 = font2.render('PBO Project of 4th Group', True, 'white')
        text_rect2 = text2.get_rect(center=(s_width/2, s_height/2+40))
    ...
    def game_over_screen(self):
        ...
        while True:
            ...
            if self.game_over_sound_delay > 360:
    ...
    def create_lives(self):
        ...
        self.live_img = pygame.transform.scale(self.live_img, (20,19))
        n = 0
